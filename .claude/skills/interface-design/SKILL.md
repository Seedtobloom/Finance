...
description: "Craft-first interface design for dashboards, admin panels, SaaS apps, tools, client portals and data interfaces. Use when designing, building, reviewing or refining product UI. Not for landing pages or marketing sites."
---

<!-- Source : github.com/Dammyjay93/interface-design (licence MIT, Damola Akinleye) -->
...
# Design status and audits

If the user asks for design status, audit, or pattern extraction in natural language: read `.interface-design/system.md` and summarize it, check UI files against it for drift, or scan for repeated spacing/radius/color/component values and propose a system.md — perform the equivalent inline.