...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v127 · Suivi « ce que je me verse » restructure en deux segments aeres : « Ce mois » (saisie + resultat verse/conseille/ecart ensemble) puis « Historique 6 derniers mois » (barres plus espacees). Aeration + lisibilite.</span>
    </div>
