...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v129 · Bornes de « Combien me verser » rendues comprehensibles : repere « toi » sur la barre, phrase qui raconte la marge (du minimum vital au plafond soutenable), explication du plancher bas (aides), libelles clarifies.</span>
    </div>
...
function renderProjetsVie(){
  ...
  if(!projetsAll.length){el.innerHTML=\`<div class="card" style="padding:32px;text-align:center;border:1.5px dashed var(--border);background:none;">
  ...
  el.innerHTML=overview+list+finisHtml;
}
