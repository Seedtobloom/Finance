...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v125 · « Ou va mon argent » reduit a l'essentiel : deux cartes claires — « tu peux encore te verser X ce mois (jusqu'au conseille) » et « le reste demeure ta tresorerie ». Suppression des pots formation/epargne/tresorerie en % (allocations theoriques faisant doublon avec les enveloppes).</span>
    </div>
