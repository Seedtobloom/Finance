...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v133 · Reste-a-vivre base sur ce qui est REELLEMENT verse : computeResteAVivre utilise le verse du mois (saisie manuelle prioritaire, sinon Qonto « Versement perso ») au lieu de la remuneration decidee. Accueil et Budget perso mis a jour (chiffre + jauge + libelle « Verse ce mois »). La remu decidee reste la reference de « Combien me verser · decision prise ».</span>
    </div>
