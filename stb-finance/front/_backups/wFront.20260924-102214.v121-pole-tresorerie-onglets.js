...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v121 · Regroupement par pole (onglets) : pole « Ma tresorerie » reunit Repartition / Comptes / Transactions / Depenses / Charges fixes / URSSAF / Reserve en une barre d'onglets ; le menu passe de 8 entrees « Argent » a une seule. Objectifs deplace dans Parametres. Navigation seulement, aucun calcul touche.</span>
    </div>
...
function loadVersement(){
  ...
  const repartHtml=\`<div class="col-12"><div class="card" style="padding:24px 26px;">
    <div style="display:flex;justify-content:space-between;align-items:baseline;flex-wrap:wrap;gap:10px;margin-bottom:4px;">
      <span style="font-size:13.5px;text-transform:uppercase;letter-spacing:.06em;color:var(--terre-400);font-weight:600;"><i class="ti ti-arrows-split-2"></i> Répartition du disponible</span>
      <span style="font-size:13px;color:var(--text-2);">Disponible <strong style="color:var(--navy);">\${fmt(dispo)}</strong></span>
    </div>
    <div style="font-size:12px;color:var(--text-2);margin-bottom:14px;">Ton disponible réparti selon tes règles (modifiables dans Options). Le versement tient compte de ce que tu t'es déjà versé ce mois.</div>
    \${repInner}
  </div></div>\`;
  el.innerHTML=\`<div class="grid12">
