...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v116 · Projets de vie : cloture manuelle. Un projet peut etre marque termine meme sous sa cible (bouton coche), il sort des totaux/financement/barres et passe dans « Projets termines » (rouvrable). Changement de comportement, aucun mouvement d'argent.</span>
    </div>
