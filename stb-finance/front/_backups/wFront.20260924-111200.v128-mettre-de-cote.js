...
<head>
  ...
  <link rel="stylesheet" href="/style.css?v=128" />
</head>
<body>
...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v128 · Combien me verser : nouvelle vue « Mettre de cote · mes objectifs » sous « Ou va mon argent » — liste unifiee des projets de vie actifs + objectifs d epargne, avec epargne reelle, affecte/mois et disponible/depassement, progression par objectif. Vue unifiee (lecture des deux sources) ; fusion des donnees en un seul ecran a suivre.</span>
    </div>
