...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v123 · Combien me verser : part versement de la repartition plafonnee au conseille (#2) — un seul montant de reference, fini la contradiction 1429/2090 ; le surplus (au-dela du conseille) bascule en tresorerie. Ecran aere (espacements, paddings, cartes de repartition plus respirantes).</span>
    </div>
