...
<div id="app">
  ...
  <aside id="sidebar">
    <div class="sidebar-logo">
      ...
      <span style="display:block;font-size:10px;letter-spacing:.04em;color:var(--text-2);opacity:.7;margin-top:2px;">build v110 · Projets : graphe fantome recadre sur le socle recurrent securise (plus l'objectif) + legende clarifiee ; KPI recadres sur les projets en cours (facture et reste = somme des restes par projet, plus de 106%/0)</span>
    </div>
